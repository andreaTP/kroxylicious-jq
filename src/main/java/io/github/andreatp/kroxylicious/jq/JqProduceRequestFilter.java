...
/**
 * A jq ProduceRequestFilter implementation, intended to demonstrate how custom filters work with
 * Kroxylicious.<br />
 * <br />
 ...
 */
public class JqProduceRequestFilter implements ProduceRequestFilter {

    private final JqFilterConfig config;
    private final Timer timer;

    public JqProduceRequestFilter(JqFilterConfig config) {
        this.config = config;
        this.timer = Timer
                .builder("jq_produce_request_filter_transform")
                .description("Time taken for the JqProduceRequestFilter to transform the produce data.")
                .tag("filter", "JqProduceRequestFilter")
