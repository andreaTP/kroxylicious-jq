...
class JqFetchResponseFilterTest {
    ...
    private static final String POST_TRANSFORM_VALUE = "{\"title\":\"First post\",\"author\":\"Anonymous Coward\"}\n" +
            "{\"title\":\"A well-written article\",\"author\":\"Person McPherson\"}\n";
    private static final String CONFIG_JQ_FILTER = ".realnames as $names | .posts[] | {title, author: $names[.author]}";
    @Mock
    ...
    private JqFetchResponseFilter filter;
    ...
    public void beforeEach() {
        ...
        this.filter = new JqFetchResponseFilter(config);
     ...
     * the JqFetchResponseFilter during the test, after which it will attempt to perform a
     ...
     * @return the FetchResponseData object to be passed to the JqFetchResponseFilter during the test
     */
